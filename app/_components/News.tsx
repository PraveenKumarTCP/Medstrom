...
const newsArticles = [
  { id: 1, title: "Meet the Medstrom Team: Emma", date: "18 March 2026", image: "/images/home/news-1.jpg" },
  { id: 2, title: "Infection Control Challenges in Corridor Care", date: "6 March 2026", image: "/images/home/news-2.png" },
  { id: 3, title: "Fundamentals of Care | The Importance of Patient Washing", date: "17 February 2026", image: "/images/home/news-3.jpg" },
];

export default function News() {
  return (
    <section className="py-18 bg-white" id="news">
      <div className="container mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-14 flex flex-col items-center">
          <h4 className="text-[#2A317A] font-bold text-md mb-3">Our News</h4>
