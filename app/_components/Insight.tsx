...
export default function Insight() {
  return (
    <div className="relative">
      <section className="pt-14 pb-42 bg-[#2A317A]" id="insight">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl lg:text-[40px] font-bold text-white leading-[1.15] mb-5">
      ...
      <div className="container mx-auto px-4 max-w-[1200px] -mt-32 mb-24 relative z-10">
        <div className="w-full aspect-[16/9] rounded-2xl bg-[#E2EAF4] shadow-[0_20px_50px_rgba(0,0,0,0.4)] overflow-hidden">
          <video
